...
func _ready() -> void:
	if GameManager.player_element_selected in element_spells:
		var spells = element_spells[GameManager.player_element_selected]

		# Assign theme instead of icon
		if GameManager.player_element_selected in elements_button:
			var theme = elements_button[GameManager.player_element_selected]
			button1.theme = theme
			button2.theme = theme
			button3.theme = theme
...
func _on_button_pressed() -> void:
	GameManager.player_spell_selected = button1.text
	print(GameManager.player_spell_selected)
	get_tree().change_scene_to_file("res://scenes/main_scenes/finger_spell_screen.tscn")
	
	
func _on_button_2_pressed() -> void:
	GameManager.player_spell_selected = button2.text
	print(GameManager.player_spell_selected)
	get_tree().change_scene_to_file("res://scenes/main_scenes/finger_spell_screen.tscn")

func _on_button_3_pressed() -> void:
	GameManager.player_spell_selected = button3.text
	print(GameManager.player_spell_selected)
	get_tree().change_scene_to_file("res://scenes/main_scenes/finger_spell_screen.tscn")
